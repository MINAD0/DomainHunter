      ...
      <PageTitle
        ...
        actions={
          <>
            ...
            <a className={`${buttonClass} bg-blue text-white hover:bg-blue-700`} href={exportUrl("csv")}>
              <Download className="h-4 w-4" aria-hidden="true" />
              Export CSV
            </a>
            <a className={`${buttonClass} bg-navy text-white hover:bg-slate-800`} href={exportUrl("txt")}>
              <Download className="h-4 w-4" aria-hidden="true" />
              Export TXT
            </a>
          </>
